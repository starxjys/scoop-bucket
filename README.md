...
| packwiz | [packwiz.json](bucket/packwiz.json) | Minecraft 整合包命令行工具（CurseForge/Modrinth 自动更新），由 [starxjys/packwiz](https://github.com/starxjys/packwiz) 自动构建官方源码的 nightly 发布 | ✅ checkver + autoupdate（滚动发布） |
